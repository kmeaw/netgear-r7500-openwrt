...
define KernelPackage/ata-ahci-platform
  ...
  AUTOLOAD:=$(call AutoLoad,40,ahci_platform,1)
...
define KernelPackage/ata-msm
  TITLE:=Qualcomm MSM AHCI SATA support
  KCONFIG:=\
	CONFIG_SATA_AHCI_MSM \
	CONFIG_SATA_AHCI_PLATFORM
  FILES:=$(LINUX_DIR)/drivers/ata/ahci_msm.ko
  AUTOLOAD:=$(call AutoLoad,41,ahci_msm,1)
  $(call AddDepends/ata)
endef

define KernelPackage/ata-imx/description
 SATA support for the Qualcomm MSM SoC's onboard AHCI SATA
endef

$(eval $(call KernelPackage,ata-msm))
